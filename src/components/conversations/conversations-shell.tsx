        ...
        <div className="flex w-full max-w-sm flex-col border-r border-slate-200 bg-white">
          <div className="border-b border-slate-100 p-3">
            <input
              ...
              className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm outline-none ring-emerald-500/20 focus:ring-2"
            />
          </div>
          <div className="scrollbar-thin flex-1 overflow-y-auto">
            {loadingList ? (
              ...
              <div className="p-4 text-sm text-slate-500">No contacts yet.</div>
            ) : (
              filtered.map((c) => {
            ...
            <>
              <div className="flex items-center gap-3 border-b border-black/5 bg-[#f0f2f5] px-4 py-3">
                ...
                <div className="min-w-0">
                  ...
                  <div className="truncate text-xs text-slate-600">{selected.phone}</div>
                </div>
              </div>
              ...
              <div className="border-t border-black/5 bg-[#f0f2f5] p-3">
                <div className="mx-auto flex max-w-3xl gap-2">
                  <textarea
                    ...
                    className="min-h-[44px] flex-1 resize-none rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none ring-emerald-500/20 focus:ring-2"
                  />
                  <button
                    type="button"
                    disabled={sending || !draft.trim()}
                    onClick={() => void send()}
                    className="self-end rounded-xl bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700 disabled:opacity-50"
                  >
                    {sending ? "…" : "Send"}
                  </button>
                </div>
